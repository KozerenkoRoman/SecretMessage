<template>
  <div
    class="flex flex-col h-full bg-brand-bg-dark/60 border border-slate-800/80 rounded-xl overflow-hidden backdrop-blur-sm shadow-inner"
  >
    <div
      class="px-3 py-1.5 border-b border-slate-800/80 bg-brand-surface/40 flex justify-between items-center flex-shrink-0"
    >
      <span
    ...
    <div
      ref="logContainer"
      class="flex-1 overflow-y-auto p-2 custom-scrollbar space-y-1.5 text-left text-xs selection:bg-amber-500/30"
    >
      <div
      ...
      >
        ...
        <span class="text-slate-200 leading-normal break-words text-[11px] flex-1">
          <i18n-t :keypath="log.messageKey" scope="global">
            <template #player>
...
// Хелпер автоматичного скролу вниз до свіжої події
...
// Слідкуємо за наповненням масиву подій і скролимо вниз
watch(
