...
export const en = {
  ...
  titles: {
    ...
    simulation: 'Bot Simulations | Secret Message',
  ...
  admin: {
    ...
    simulationsLink: "Bot Simulations →",
  },

  // ==== Bot simulation dashboard =====================================
  simulation: {
    title: "Bot Simulation Lab",
    subtitle: "Run headless Bot-vs-Bot batches and analyze strategy performance",
    backToAdmin: "← Back to Admin",
    config: {
      title: "Batch Configuration",
      count: "Number of games",
      seed: "Base seed (0 = random)",
      slots: "Bot slots",
      slot: "Slot",
      strategy: "Strategy",
      addSlot: "+ Add bot",
      removeSlot: "Remove",
      firstMove: "Force first move",
      firstMoveNone: "Default order",
      launch: "Launch Simulation",
      launching: "Launching...",
      strategies: {
        smart: "Smart (production AI)",
    ...
    progress: {
      ...
      status: "Status",
      games: "Games",
      idle: "No simulation running. Configure and launch a batch above.",
      running: "Running",
      completed: "Completed",
      failed: "Failed",
      cancelled: "Cancelled",
      cancel: "Cancel batch",
      avgTurns: "Avg turns/game",
      avgRounds: "Avg rounds/game",
      avgDuration: "Avg duration",
      draws: "Draws",
      invalid: "Invalid moves",
      fallback: "Fallback moves",
    },
    results: {
      winRates: "Win Rate per Strategy",
      cardUsage: "Card Play Distribution",
      eliminations: "Eliminations by Reason",
      strategyTable: "Strategy Breakdown",
      ...
      colFirstMoveWin: "1st-move Win %",
      noData: "No results yet.",
    },
    errors: {
      launchFailed: "Failed to launch simulation.",
      loadFailed: "Failed to load simulation status.",
      minSlots: "At least 2 bot slots are required.",
    },
  },
  ...
  profile: {
    ...
    uploadHint: "PNG, JPEG, WebP or SVG, up to {maxMb} MB",
    ...
    errors: {
      ...
      invalidType: "Only PNG, JPEG, WebP, or SVG files are allowed",
      tooLarge: "File is too large (max {maxMb} MB)",
