...
export const uk = {
  ...
  titles: {
    ...
    simulation: 'Симуляції ботів | Таємне Послання',
  ...
  admin: {
    ...
    simulationsLink: "Симуляції ботів →",
  },

  // ==== Bot simulation dashboard =====================================
  simulation: {
    title: "Лабораторія симуляцій ботів",
    subtitle: "Запуск headless-батчів Бот-проти-Бота та аналіз стратегій",
    backToAdmin: "← Назад до адмінки",
    config: {
      title: "Конфігурація батча",
      count: "Кількість ігор",
      seed: "Базовий seed (0 = випадковий)",
      slots: "Слоти ботів",
      slot: "Слот",
      strategy: "Стратегія",
      addSlot: "+ Додати бота",
      removeSlot: "Прибрати",
      firstMove: "Примусовий перший хід",
      firstMoveNone: "Звичайний порядок",
      launch: "Запустити симуляцію",
      launching: "Запуск...",
      strategies: {
        smart: "Розумний (продакшн ШІ)",
        random: "Випадковий (базова лінія)",
      },
    },
    progress: {
      title: "Живий прогрес",
      status: "Статус",
      games: "Ігри",
      idle: "Симуляція не запущена. Налаштуйте та запустіть батч вище.",
      running: "Виконується",
      completed: "Завершено",
      failed: "Помилка",
      cancelled: "Скасовано",
      cancel: "Скасувати батч",
      avgTurns: "Сер. ходів/гру",
      avgRounds: "Сер. раундів/гру",
      avgDuration: "Сер. тривалість",
      draws: "Нічиї",
      invalid: "Невалідні ходи",
      fallback: "Fallback-ходи",
    },
    results: {
      winRates: "Win-rate по стратегіях",
      cardUsage: "Розподіл зіграних карт",
      eliminations: "Вибуття за причиною",
      strategyTable: "Деталізація по стратегіях",
      colStrategy: "Стратегія",
      colGames: "Ігри",
      colWins: "Перемоги",
      colWinRate: "Win %",
      colSpy: "Бонус Шпигуна",
      colMoves: "Ходи",
      colInvalid: "Невалідні",
      colFallback: "Fallback",
      colFirstMoveWin: "Перемоги з 1-го ходу %",
      noData: "Ще немає результатів.",
    },
    errors: {
      launchFailed: "Не вдалося запустити симуляцію.",
      loadFailed: "Не вдалося завантажити статус симуляції.",
      minSlots: "Потрібно щонайменше 2 слоти ботів.",
    },
  },
  ...
  roomSettings: {
    ...
    winnerStartsNextRound: "Переможець починає наступний раунд",
    winnerStartsNextRoundHint:
      "Якщо увімкнено, гравець, який переміг у попередньому раунді, робить перший хід у наступному.",
    hostOnlyHint: "Змінювати налаштування кімнати може лише її власник.",
    close: "Закрити",
  },
  ...
  profile: {
    ...
    uploadHint: "PNG, JPEG, WebP або SVG, до {maxMb} MB",
    uploadSuccess: "Аватар успішно оновлено!",
    ...
    errors: {
      ...
      invalidType: "Дозволені лише файли PNG, JPEG, WebP або SVG",
      tooLarge: "Файл занадто великий (максимум {maxMb} MB)",
      uploadFailed: "Не вдалося завантажити аватар. Спробуйте ще раз.",
    },
  },
  ...
  gameEnd: {
    ...
    restart: "Грати знову",
    nextRoundStarter: "Перший хід:",
    winnerStartsBadge: "Переможець раунду",
  },
