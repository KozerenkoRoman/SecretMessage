...
export const uk = {
  ...
  rules: {
    ...
    nuance3: "Для повної перемоги в партії потрібно набрати певну кількість жетонів прихильності (залежить від кількості учасників у кімнаті).",
    ...
    strategy6: "Шпигун (0) дозволяє заробити додатковий жетон прихильності, навіть якщо ви програли сам раунд",
  },
};
